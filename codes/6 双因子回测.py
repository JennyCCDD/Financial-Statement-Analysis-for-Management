...
class Para():
    ...
    factor = 'operating_asset'
    factor2 = 'interest_rate_after_tax'
...
class main():
    def __init__(self):
        ...
        Factor2 = pd.read_csv(para.result_path + para.factor2 + '.csv', index_col=0).T
    ...
    def every_month(self):
        ...
        for i, currentDate in enumerate(tqdm(self.tradingDateList[:-2])):
            ...
            Des = self.dataFrame['%s' % para.factor].describe()
...
if __name__ == "__main__":
    ...
    print(test_nav_abs)
    # In[]
    test_nav_abs.to_csv(para.result_path + '_' + para.factor + '_' + para.factor2 + '_' + para.weightMethod +
    ...
    test_abs.to_csv(para.result_path + '_' + para.factor + '_' + para.factor2 + '_' + para.weightMethod +
